...
<section className="c-section cc-center">
        <div className="c-container">
          ...
          <div lottie-bg="" className="lottie-crop cc-market">
            <div className="lottie_cropped-desktop cc-market" data-w-id="285cfcf1-51c6-d2fa-a2d6-ede8fa2381fb" data-animation-type="lottie" data-src="documents/Generative-Loop-Final-25.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="10"></div>
            <div slice="" className="lottie_cropped-mobile" data-w-id="285cfcf1-51c6-d2fa-a2d6-ede8fa2381fc" data-animation-type="lottie" data-src="documents/Generative-Loop-Final.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="0"></div>
          </div>
        </div>
      </section>
      ...
      <section no-fade="" className="c-section">
        <div className="c-container">
          <div className="slider-wrap">
            <div className="slider_lottie" data-w-id="8f980da0-ddc4-ceaf-1ed0-830cc78e90ad" data-animation-type="lottie" data-src="documents/Testimonial-BG-25.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="20"></div>
...
<section className="c-section cc-center">
        <div className="c-container">
          ...
          <div lottie-bg="" className="lottie-crop cc-market">
            <div className="lottie_cropped-desktop cc-market" data-w-id="75619d1a-78b4-96ff-3dc0-f26a0a3c5251" data-animation-type="lottie" data-src="documents/Generative-Loop-Final-25.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="10"></div>
            <div slice="" className="lottie_cropped-mobile" data-w-id="75619d1a-78b4-96ff-3dc0-f26a0a3c5252" data-animation-type="lottie" data-src="documents/Generative-Loop-Final.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="0"></div>
          </div>
        </div>
      </section>
      <section className="c-section cc-tp-50">
      ...
      <section no-fade="" className="c-section">
        <div className="c-container">
          <div className="slider-wrap">
            <div className="slider_lottie" data-w-id="75619d1a-78b4-96ff-3dc0-f26a0a3c52fa" data-animation-type="lottie" data-src="documents/Testimonial-BG-25.json" data-loop="1" data-direction="1" data-autoplay="1" data-is-ix2-target="0" data-renderer="svg" data-default-duration="0" data-duration="20"></div>
            <div className="slider w-dyn-list">
              <div slider="" role="list" className="slider_list w-dyn-items">
                <div role="listitem" className="slider_cms-item w-dyn-item">
                  <div className="slider_item">
