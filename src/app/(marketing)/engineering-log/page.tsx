                ...
                <a href="#" className="grid cc-featured w-inline-block">
                  ...
                  <div id="w-node-f9b03eb8-910b-ab17-f4ee-5292131266ca-78bc35b2" className="aspect-16-9 u-overflow-hidden"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" className="img-cover w-dyn-bind-empty" />
                    <div className="featured-svg">
                      ...
                      <div data-is-ix2-target="1" className="cta-lottie" data-w-id="97ecced1-deb7-c354-caf9-40c127a1b4f3" data-animation-type="lottie" data-src="documents/Arrow-Lottie.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="0" data-duration="0"></div>
                    </div>
                  </div>
                        ...
                        <div className="w-dyn-list">
                          <div role="list" className="author-list w-dyn-items">
                            <div r-filter="author" role="listitem" className="w-dyn-item"><label className="w-checkbox c-text-6 cc-dropdown">
                                <div className="w-checkbox-input w-checkbox-input--inputType-custom author-checkbox"></div><input type="checkbox" name="checkbox" id="checkbox" data-name="Checkbox" style={{opacity: "0", position: "absolute", zIndex: "-1"}} /><span className="w-form-label" for="checkbox"></span>
                              </label></div>
                          </div>
                          <div className="w-dyn-empty">
                            <div>No items found.</div>
