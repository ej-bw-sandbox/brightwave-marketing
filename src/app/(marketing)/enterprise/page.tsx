          ...
          <div className="slider-wrap">
            ...
            <div className="slider w-dyn-list">
              <div slider="" role="list" className="slider_list w-dyn-items">
                ...
                <div key={i} role="listitem" className="slider_cms-item w-dyn-item">
                  <div className="slider_item">
                    <div slider-a-1="" className="slider_flex ent-price">
                      <div slider-a-3="" className="eyebrow-flex">
                        ...
                        <div className="c-title-5 cc-primary">{t.attribution}</div>
                      </div>
            ...
            <div className="footer">
              <div className="footer_content">
                <div className="v-48 cc-footer">
                  <div className="c-text-1">{doc?.footerTagline}</div>
                  <div className="invert">
                    <div className="dark-mode-invert">
                      <a stagger-cta="" href={doc?.footerCtaUrl} className="cta-p-sm cc-stroke w-inline-block">
                        <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">{doc?.footerCtaLabel}</div>
                        <div className="flip-small">
                          <div className="flip-bg"></div>
                        </div>
                        <div className="flip-big">
