        ...
        <div className="c-container">
          <div className="ent-pricing_hero-content">
            <div className="c-ent-price_hero-wrapper">
              <div>
                <h1 className="c-title-3">{doc?.heroHeadline}</h1>
              </div>
              <div className="text-cta ent-price-hero">
                <div>
                  <div className="c-text-3">{doc?.heroSubheadline}</div>
                </div>
                <div className="h-20">
                  {(doc?.heroCtas ?? []).map((cta: any, i: number) => (
                    <a key={i} stagger-cta="" href={cta.url} className={i === 0 ? "cta-p-sm w-inline-block" : "cta-p-sm cc-stroke w-inline-block"} {...(cta.openInNewTab ? { target: '_blank', rel: 'noopener noreferrer' } : {})}>
                      {i === 0 && <div><div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">{cta.label}</div></div>}
                      {i !== 0 && <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">{cta.label}</div>}
            ...
            <div>
              <div className="small-marquee_wrapper">
                <div className="small-marquee_header">
                  <div className="c-title-5">{doc?.socialProofHeadline}</div>
                </div>
...
` }} />
            ...
            <div className="partner-proofs_wrapper">
              <div>
                <div className="eyebrow cc-no-bp blue">
                  ...
                  <div className="c-title-5">{doc?.proofPointsEyebrow}</div>
                </div>
              </div>
              <div className="partner-proof_points col-3">
                {(doc?.proofPoints ?? []).map((point: any, i: number) => (
                  <div key={i} className="partner-proof_point">
                    <h3 className="c-title-4">{point.value}</h3>
          ...
          <div className="v-64 cc-stretch">
            ...
            <div className="ent-price-research_main-wrapper">
              <div id="w-node-_26ce0361-b134-8876-cb28-6c8325fe2322-0464d2c1" className="stretch-child">
                <div className="c-text-4">{doc?.researchBody}</div>
              </div>
        ...
        <div className="c-container">
          <div className="c-abm-temp_chal_main-wrapper">
            <div className="c-abm-temp-chal_header-wrapper">
              <div className="c-abm-temp-chal_header">
                <div className="c-amb-temp-chal_box"></div>
                <div className="c-title-5">{doc?.capabilitiesEyebrow}</div>
              </div>
            </div>
            <div className="c-abm-temp-chal_card-wrapper c-abm-template_grid">
              <div id="w-node-a775d520-4823-fc86-7112-94123056007b-0464d2c1" className="c-amb-temp-chal_sticky">
                <div className="c-abm-temp-chal_title-wrapper">
                  <h2 className="c-title-3">{doc?.capabilitiesStickyTitle}</h2>
                </div>
              ...
              <div id="w-node-a775d520-4823-fc86-7112-941230560082-0464d2c1" className="c-abm-temp-chal_card-list">
                {(doc?.capabilityCards ?? []).map((card: any, i: number) => (
                <div key={i}>
                  <div className="c-abm-temp-chal_card">
                    <div className="c-abm-temp-chal_card-content">
                      <div className="c-text-3 cc-500">{card.title}</div>
                      <div className="c-text-5">{card.subtitle}</div>
                    </div>
                    <div className="c-abm-temp-chal_card-highlight">
                      ...
                      <div className="c-abm-temp-chal_card-text-stack">
                        <div className="c-abm-temp-chal_card-title-wrapper">
                          <div className="c-text-4 cc-weight-500">{card.howHelpsLabel}</div>
                        </div>
                        <div className="c-abm-temp-chal_card-text-wrapper">
                          <p className="c-text-5">{card.howHelpsText}</p>
                        </div>
                      </div>
        ...
        <div className="c-container">
          <div className="partner-list_wrapper">
            <div className="partner-list_title">
              <h3 className="c-title-3">{doc?.byTheNumbersHeadline}</h3>
              <a stagger-cta="" href="#" className="cta-p-sm w-inline-block">
                <div>
                  <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">Book a demo</div>
                </div>
          ...
          <div>
            <div className="v-40">
              <div className="c-abm-temp-chal_header-wrapper">
                <div className="c-abm-temp-chal_header">
                  <div className="c-amb-temp-chal_box"></div>
                  <div className="c-title-5">{doc?.securityEyebrow}</div>
                </div>
              </div>
              <div className="h-flex-20">
                {(doc?.securityCertifications ?? []).map((cert: any, i: number) => {
                  const images = [
                    { light: '/webflow-images/illustration_Enterprise-Trust--Security.svg', dark: '/webflow-images/illustration_Enterprise-Trust--Security-1.svg' },
                    { light: '/webflow-images/illustration_Investment-Intelligence-Engine.svg', dark: '/webflow-images/illustration_Investment-Intelligence-Engine-1.svg' },
                  ]
                  const img = images[i % images.length]
                  return (
                    <div key={i} className="explore-item">
                      <div className="aspect-16-9">
                        <div className="u-relative"><img src={img.light} loading="lazy" width="70" light-asset="" alt="" className="image-abso" /><img src={img.dark} loading="lazy" width="70" dark-asset="" alt="" className="image-abso" /></div>
                      </div>
                      <div className="v-64 cc-fill">
                        <div className="v-20 cc-explore">
                          <div className="c-title-3">{cert.title}</div>
                          <div>
                            <div className="c-text-4">{cert.description}</div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="c-abm-temp_chal_main-wrapper">
            <div className="c-abm-temp-chal_card-wrapper c-abm-template_grid">
              <div id="w-node-_5f88d3a5-961e-345d-f130-ff55642cc44b-0464d2c1" className="c-amb-temp-chal_sticky">
                <div className="c-abm-temp-chal_title-wrapper">
                  <h2 className="c-title-2">{doc?.securityFeaturesHeadline}</h2>
                </div>
                <div className="c-abm-temp-chal_button-wrapper">
                  <a stagger-cta="" href={doc?.securityFeaturesCtaUrl} className="cta-p-sm w-inline-block">
                    <div>
                      <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">{doc?.securityFeaturesCtaLabel}</div>
                    </div>
                    <div className="flip-small">
                      <div className="flip-bg"></div>
                    </div>
              ...
              <div id="w-node-_5f88d3a5-961e-345d-f130-ff55642cc454-0464d2c1" className="c-abm-temp-chal_card-list">
                {(doc?.securityFeatures ?? []).map((feature: any, i: number) => (
                  <div key={i} className="v-12">
                    <div className="c-title-5">{feature.title}</div>
                    <div className="c-text-4">{feature.description}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="c-container">
          <div className="v-48">
            <div className="ent-price-head">
              <h2 className="c-title-4">{doc?.whyChooseHeadline}</h2>
            </div>
            ...
            <div className="ent-price-card-grid">
              {(doc?.whyChooseCards ?? []).map((card: any, i: number) => (
                <div key={i} id="w-node-a29a653e-f15e-d745-d2a0-721a238a6540-238a6540" className="ent-price-dark-card">
                  <div className="ent-price-dark-card_header">
                    <div className="eyebrow-box"></div>
                    <div className="c-title-5">{card.eyebrow}</div>
                  </div>
                  <div>
                    <p className="c-text-5">{card.body}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="c-section ent-price">
        <div className="c-container">
          <div className="v-48">
            <div className="ent-price-head">
              <h2 className="c-title-3">{doc?.timelineHeadline}</h2>
            </div>
            <div className="ent-price-timeline-grid">
              {(doc?.timelineSteps ?? []).map((step: any, i: number) => (
                <div key={i} id="w-node-_09b67bba-09f7-03c4-2ba6-4d083c51c7ad-3c51c7ad" className="ent-price-timeline-item">
                  <div className="ent-price-timeline-top">
                    <div className="ent-price-timeline-box"></div>
                    <div className="c-title-5">{String(i + 1).padStart(2, '0')}</div>
                    <div className="ent-price-divider"></div>
                  </div>
                  <div className="ent-price-timeline-bottom">
                    <div className="div-block-106">
                      <div className="c-text-4 cc-weight-500">{step.title}</div>
...
<style dangerouslySetInnerHTML={{ __html: `
  ...
  /* Enterprise dark cards: keep dark appearance in dark mode */
  [theme="dark"] .ent-price-dark-card,
  .u-dark-mode .ent-price-dark-card {
    background-color: var(--colorprimitives--gray-800);
    color: var(--colorprimitives--gray-50);
  }
  [theme="dark"] .ent-price-dark-card .eyebrow-box,
  .u-dark-mode .ent-price-dark-card .eyebrow-box {
    background-color: var(--colorprimitives--gray-50);
  }
  [theme="dark"] .ent-price-dark-card .c-title-5,
  .u-dark-mode .ent-price-dark-card .c-title-5,
  [theme="dark"] .ent-price-dark-card .c-text-5,
  .u-dark-mode .ent-price-dark-card .c-text-5 {
    color: var(--colorprimitives--gray-50);
  }
` }} />
  </div>
