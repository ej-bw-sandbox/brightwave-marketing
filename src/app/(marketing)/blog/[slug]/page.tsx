...
export default async function BlogDetailPage({ params }: PageProps) {
  ...
  const formattedDate = post.publishedAt
    ...
    : null
  const categoryLabel = 'Our Insights'
        ...
        <div className="c-container">
          <div className="content">
            <div className="grid cc-template">
              <div id="w-node-_7f0f3a8d-fdd2-537d-0a84-756f4cc47084-0056d0f9" className="template">
                <div className="template_mobile">
                  <Link href="/blog" className="eyebrow-flex cc-mobile w-inline-block">
              ...
              <div id="w-node-_7f0f3a8d-fdd2-537d-0a84-756f4cc4709e-0056d0f9" className="u-overflow-hidden">
            ...
            <div className="grid">
              <div id="w-node-_7f0f3a8d-fdd2-537d-0a84-756f4cc470a2-0056d0f9">
                <div className="template_sticky">
                  <div className="c-text-4">Share on</div>
                  <div className="text-flex cc-socials">
                    <a href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://www.brightwave.io/blog/${slug}`)}`} target="_blank" rel="noopener noreferrer" className="social w-inline-block">
                    ...
                    <a href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.brightwave.io/blog/${slug}`)}&text=${encodeURIComponent(post.title || '')}`} target="_blank" rel="noopener noreferrer" className="social w-inline-block">
                      <div className="c-text-link">X</div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 9 8" fill="none" className="linkedin-svg">
                        <g clipPath="url(#clip0_884_647b)">
                          <path d="M8.1123 7.08496L8.1123 0.364378L1.43446 0.364378" stroke="currentColor" strokeWidth="0.725064" strokeLinejoin="bevel" />
                          <path d="M8.1123 0.365358L0.781907 7.74268" stroke="currentColor" strokeWidth="0.725064" strokeLinejoin="bevel" />
                        </g>
                        <defs>
                          <clipPath id="clip0_884_647b">
                            <rect width="8" height="7.94912" fill="currentColor" transform="matrix(-4.37114e-08 -1 -1 4.37114e-08 8.47461 8)" />
                          </clipPath>
                        </defs>
                      </svg>
              ...
              <div id="w-node-a546bb2a-b401-7c2e-6f3f-2f47f8731b9b-0056d0f9" className="rich-text w-richtext">
              ...
              <div className="cta-step">
                <Link href="/contact" className="cta-p-big w-inline-block">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 35 33" fill="none" className="cta-p-big_arrows cc-hide">
                    ...
                    <g clipPath="url(#clip0_913_4549_detail)">
                    ...
                    <defs>
                      <clipPath id="clip0_913_4549_detail">
                ...
                <div className="w-dyn-list">
                  <div role="list" className="grid cc-cards w-dyn-items">
                    {relatedPosts.map((rp: any) => (
                      <div key={rp.slug?.current} id="w-node-ab046570-f784-b66c-7142-a1659c0724b2-0056d0f9" role="listitem" className="card_item w-dyn-item">
                        <Link href={`/blog/${rp.slug?.current || ''}`} className="card w-inline-block">
                    ...
                    <div className="flip-big">
                      <div className="svg cta-sm-arrow w-embed">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <g clipPath="url(#clip0_774_4073_blog)">
                          ...
                          <defs>
                            <clipPath id="clip0_774_4073_blog">
