...
export const metadata: Metadata = {
  title: 'Release Notes | Brightwave',
...
<section className="c-section cc-template">
        <div className="c-container">
          <div className="bp40-underline">
            <h1 className="c-title-1">Release Notes</h1>
          </div>
          <div className="w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="card_item w-dyn-item">
                <a id="w-node-_5d10c903-76ca-1a63-9bcf-0e5539ca89e7-39ca89db" href="#" className="grid cc-featured w-inline-block">
                  <div inject-landscape-target="featured" id="w-node-_5d10c903-76ca-1a63-9bcf-0e5539ca89e8-39ca89db" className="inject-landscape"></div>
                  <div id="w-node-_5d10c903-76ca-1a63-9bcf-0e5539ca89e9-39ca89db" className="aspect-16-9 u-overflow-hidden"><img loading="lazy" src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" alt="" className="img-cover w-dyn-bind-empty" />
                    <div className="featured-svg">
                      ...
                      <div data-is-ix2-target="1" className="cta-lottie" data-w-id="5d10c903-76ca-1a63-9bcf-0e5539ca89ed" data-animation-type="lottie" data-src="documents/Arrow-Lottie.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="0" data-duration="0"></div>
                    </div>
                  </div>
                  <div id="w-node-_5d10c903-76ca-1a63-9bcf-0e5539ca89ee-39ca89db" className="featured_right">
                    <div inject-landscape="featured" className="featured_top">
                      <div className="eyebrow-flex">
                        <div className="block"></div>
                        <div className="c-title-5">Latest</div>
                      </div>
          ...
          <div className="collection">
            <div className="form-block w-form">
              <form id="email-form" name="email-form" data-name="Email Form" redirect="/" data-redirect="/" method="get" className="filters" data-wf-page-id="696a61507601604c70bc0eeb" data-wf-element-id="5d10c903-76ca-1a63-9bcf-0e5539ca89fb">
                        ...
                        <div className="w-dyn-list">
                          <div role="list" className="author-list w-dyn-items">
                            <div r-filter="author" role="listitem" className="w-dyn-item"><label className="w-checkbox c-text-6 cc-dropdown">
                                <div className="w-checkbox-input w-checkbox-input--inputType-custom author-checkbox"></div><input type="checkbox" name="checkbox" id="checkbox" data-name="Checkbox" style={{opacity: "0", position: "absolute", zIndex: "-1"}} /><span className="w-dyn-bind-empty w-form-label" for="checkbox"></span>
                              </label></div>
                          </div>
                          <div className="w-dyn-empty">
                            <div>No items found.</div>
            ...
            <div className="collection_flex">
              <div className="w-dyn-list">
                <div fs-cmssort-element="list" r-filter-wrapper="" r-filter-load-more="9" role="list" className="grid cc-collection w-dyn-items">
                  <div id="w-node-_5d10c903-76ca-1a63-9bcf-0e5539ca8a32-39ca89db" role="listitem" className="collection_card w-dyn-item">
