...
export const metadata: Metadata = {
  ...
  description: 'Latest product updates from Brightwave.',
}
...
export default async function Page() {
  ...
  try {
    const data = await client.fetch(
      ...
      { category: 'release-notes', offset: 0, limit: 50 },
            ...
            {featured ? (
              <div role="list" className="w-dyn-items">
                <div role="listitem" className="card_item w-dyn-item">
                  <Link data-w-id="50042883-03e0-1a26-5ffd-7d11d5f0e3ba" href={`/release-notes/${featured.slug?.current || ''}`} className="grid cc-featured w-inline-block">
                    ...
                    <div id="w-node-e443da8c-33db-3129-61f5-1e4331df01f6-4c4a8e00" className="featured_right">
                      <div className="featured_top">
                        <div className="eyebrow-flex">
                          ...
                          <div className="c-title-5">Release Notes</div>
                        </div>
                ...
                <div role="list" className="grid cc-collection w-dyn-items">
                  {rest.map((post: any) => (
                    <div key={post._id} id="w-node-c5123b81-e463-2eab-695f-359de2f2994d-4c4a8e00" role="listitem" className="collection_card w-dyn-item">
                      <Link href={`/release-notes/${post.slug?.current || ''}`} className="card w-inline-block">
