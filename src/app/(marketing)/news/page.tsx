...
<section className="c-section cc-template">
        <div className="c-container">
          <div className="bp40-underline">
            <h1 className="c-title-1">News</h1>
          </div>
          <div className="w-dyn-list">
            <div role="list" className="w-dyn-items">
              <div role="listitem" className="card_item w-dyn-item">
                <a id="w-node-d14a05de-e580-5b1e-e345-8135f7808f41-ae10989c" data-w-id="d14a05de-e580-5b1e-e345-8135f7808f41" href="#" className="grid cc-featured w-inline-block">
                  <div inject-landscape-target="featured" id="w-node-e73e88d0-10c1-26c7-a42d-15a75bb1d248-ae10989c" className="inject-landscape"></div>
                  <div id="w-node-e73e88d0-10c1-26c7-a42d-15a75bb1d249-ae10989c" className="aspect-16-9 u-overflow-hidden"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" className="img-cover w-dyn-bind-empty" />
                    <div className="press_logo"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" className="press_img w-dyn-bind-empty" /></div>
                    <div className="featured-svg">
                      ...
                      <div data-is-ix2-target="1" className="cta-lottie" data-w-id="a2e6a075-a643-8413-931e-ca81425c6cbc" data-animation-type="lottie" data-src="documents/Arrow-Lottie.json" data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg" data-default-duration="0" data-duration="0"></div>
                    </div>
                  </div>
                  <div id="w-node-e73e88d0-10c1-26c7-a42d-15a75bb1d24b-ae10989c" className="featured_right">
                ...
                <a id="w-node-_13cd6148-8a62-9788-63e5-84d47ff6e20a-ae10989c" href="#" className="card_link-abso w-inline-block"></a>
              </div>
            </div>
          ...
          <div className="collection">
            <div className="form-block w-form">
              <form id="email-form" name="email-form" data-name="Email Form" redirect="/" data-redirect="/" method="get" className="filters" data-wf-page-id="6706a18d17ad3e2aae10989c" data-wf-element-id="c7d828b9-1732-fc75-702b-d19ac2b96db9">
                ...
                <div className="filters_flex">
                  ...
                  <div className="search_flex">
                    <div data-hover="false" data-delay="300" fs-cmssort-element="trigger" className="filter-dropdown w-dropdown">
                    ...
                    <div data-hover="false" data-delay="300" fs-cmssort-element="trigger" className="filter-dropdown cc-hide w-dropdown">
                      <div className="dropdown-toggle w-dropdown-toggle">
                        ...
                        <div className="w-dyn-list">
                          <div role="list" className="author-list w-dyn-items">
                            <div r-filter="author" role="listitem" className="w-dyn-item"><label className="w-checkbox c-text-6 cc-dropdown">
                                <div className="w-checkbox-input w-checkbox-input--inputType-custom author-checkbox"></div><input type="checkbox" id="checkbox-2" name="checkbox-2" data-name="Checkbox 2" style={{opacity: "0", position: "absolute", zIndex: "-1"}} /><span className="w-dyn-bind-empty w-form-label" for="checkbox-2"></span>
                              </label></div>
                          </div>
                          <div className="w-dyn-empty">
                            <div>No items found.</div>
            ...
            <div className="collection_flex">
              <div className="w-dyn-list">
                <div fs-cmssort-element="list" r-filter-wrapper="" r-filter-load-more="9" role="list" className="grid cc-collection w-dyn-items">
                  <div id="w-node-e73e88d0-10c1-26c7-a42d-15a75bb1d27e-ae10989c" role="listitem" className="collection_card w-dyn-item">
                    <a href="#" className="card w-inline-block">
                      <div className="aspect-4-3"><img alt="" loading="lazy" src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" className="img-cover w-dyn-bind-empty" />
                        <div className="press_logo"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" className="press_img w-dyn-bind-empty" /></div>
                      </div>
                      <div className="card_flex">
                        ...
                        <div fs-cmssort-type="date" fs-cmssort-field="update-date" className="c-text-6 w-dyn-bind-empty"></div>
                      </div>
                    </a>
              ...
              <div className="load-more">
                <div r-filter-load-more-button="">
                  <a stagger-cta="" href="#" className="cta-p-sm cc-stroke w-inline-block">
                    <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">Load More</div>
              ...
              <div r-filter-empty="" className="c-empty">
                <div className="c-title-3">No items found</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="c-container">
          <div className="titles">
            ...
            <div className="cta-step">
              <a stagger-cta-big="" data-w-id="f984e0fd-5317-bfcf-7b12-0d02f1476f56" href="/contact" className="cta-p-big w-inline-block">
