...
export async function generateMetadata(): Promise<Metadata> {
  const doc = await client.fetch(partnersQuery, {}, { next: { tags: ['partnersPage'], revalidate: 3600 } })
  if (!doc) return { title: 'Earn Up to $1,000 per Meeting | Brightwave Partner Program' }
  return buildMetadata({
    title: doc.title || 'Earn Up to $1,000 per Meeting | Brightwave Partner Program',
    description: doc.description || 'Join the Brightwave affiliate program and earn $1000 for each meeting you send our way. by referring Brightwave to your friends and followers.',
    seo: doc.seo,
    path: '/partners',
  })
}
...
export default async function Page() {
  ...
  try {
    doc = await client.fetch(partnersQuery, {}, { next: { tags: ['partnersPage'], revalidate: 3600 } })
  } catch {
    doc = null
  }
                ...
                <div className="c-container">
                  <div className="partner-program-hero">
                    <div className="partner-title">
                      <h1 className="c-title-1">Make a Connection, Earn up to $1,000.</h1>
                    </div>
                    <div className="partner-cta">
                      <div className="_428">
                        <div className="c-text-4">Earn <strong className="bold">industry-leading rewards</strong> by sharing the world&#x27;s most advanced research intelligence platform with colleagues. They&#x27;ll thank you.</div>
                      </div>
                      <div className="h-20">
                        <a stagger-cta="" href="https://partners.dub.co/brightwave/apply" target="_blank" className="cta-p-sm w-inline-block">
                          <div>
                            <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">Apply Today</div>
                          </div>
                ...
                <div className="partner-info_wrapper">
                  <div className="partner-info_text-col">
                    <div className="eyebrow cc-no-bp">
                      ...
                      <div className="c-title-5">Partner Program</div>
                    </div>
                    <h2 className="c-text-2">Help fellow professionals in finance and investment management discover how autonomous AI agents can transform their workflow processes.</h2>
                  </div>
                  <div className="partner-info_refer-card">
                    <div className="partner-info_icon-wrapper">
                      <div className="icon-wrapper dark">
                        <div className="svg w-embed"><svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h3 className="c-title-4">Earn up to <span className="cc-yellow">$1000</span> for each meeting you send our way.</h3>
                    </div>
                    <div className="partner-info_cta-wrapper">
                      <div className="c-text-5 w-richtext">
                        <ul role="list">
                          <li>Valid referrals cannot not work for the same company, be current Brightwave users, or be in the Brightwave pipeline</li>
                          <li>Individuals must work in private equity or private credit roles (VC inelligible)</li>
                          <li>Commission is earned after the meeting is held</li>
                        </ul>
                      </div>
                      <a stagger-cta="" href="https://partners.dub.co/brightwave/apply" target="_blank" className="cta-p-sm w-inline-block">
                        <div>
                ...
                <div className="partner-proofs_wrapper">
                  <div>
                    <div className="eyebrow cc-no-bp blue">
                      ...
                      <div className="c-title-5">At a Glance</div>
                    </div>
                  </div>
                  <div className="partner-proof_points">
                    <div className="partner-proof_point">
                      <h3 className="c-title-4">25x Faster</h3>
                      <div className="c-text-4">Accelerated analysis versus manual research workflows.</div>
                    </div>
                    <div className="partner-proof_point">
                      <h3 className="c-title-4">Hours to Minutes</h3>
                      <div className="c-text-4">Significantly cut down research time on every project.</div>
                    </div>
                    <div className="partner-proof_point">
                      <h3 className="c-title-4">75% Savings</h3>
                      <div className="c-text-4">Starting at $200/mo vs. $800/mo for legacy tools.</div>
                    </div>
                    <div className="partner-proof_point">
                      <h3 className="c-title-4">+2,000 Docs</h3>
                      <div className="c-text-4">Simultaneous document processing at massive scale.</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="c-container">
                <div className="partner-list_wrapper">
                  <div className="partner-list_title">
                    <h3 className="c-title-3">Who Should Become a Partner</h3>
                    <a stagger-cta="" href="https://partners.dub.co/brightwave/apply" target="_blank" className="cta-p-sm cc-stroke w-inline-block">
                      <div stagger-cta-text="dark" className="c-text-link cc-stagger-cta">Apply Today</div>
                      <div className="flip-small">
                        <div className="flip-bg"></div>
                      </div>
                  ...
                  <div className="partner-list_list-wrapper">
                    <div className="partner-list_list-item">
                      ...
                      <div className="c-text-3 cc-500">Private markets investors</div>
                    </div>
                    <div className="partner-list_list-item">
                      <div className="partner_icon">
                        <div className="svg w-embed"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="c-text-3 cc-500">Financial technology consultants and advisors</div>
                    </div>
                    <div className="partner-list_list-item">
                      <div className="partner_icon">
                        <div className="svg w-embed"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className="c-text-3 cc-500">Industry influencers and content creators in finance</div>
                    </div>
                    <div className="partner-list_list-item">
                      <div className="partner_icon">
                        <div className="svg w-embed"><svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="callout-info_box">
                  <div className="callout-info_text">
                    <div className="div-block-98">
                      <h2 className="c-title-3">Why Partner with Brightwave?</h2>
                      <div className="div-block-99">
                        <p className="c-text-4">Brightwave represents a breakthrough in professional research technology, offering partners the opportunity to promote a genuinely transformative solution.</p>
                        <p className="c-text-4">With SOC 2 Type II compliance, enterprise-grade security, and the ability to process 2000+ documents simultaneously, Brightwave is transforming the private markets.</p>
                      </div>
                    </div>
                    <a stagger-cta="" href="https://partners.dub.co/brightwave/apply" target="_blank" className="cta-p-sm w-inline-block">
                      <div>
            ...
            <section className="c-section partner-about">
              <div className="c-container">
                <div className="partner-about_title">
                  <h3 className="c-title-3">About Brightwave</h3>
                </div>
                <div className="partner-about_wrapper">
                  <div className="partner-about_text-wrapper">
                    <p className="c-text-4">Brightwave is revolutionizing professional research with AI-powered autonomous agents that can process thousands of documents simultaneously, generate comprehensive reports in minutes, and surface critical insights that human analysts might miss.</p>
                    <p className="c-text-4">Trusted by hedge funds, private equity firms, and institutional investors managing billions in assets, Brightwave transforms complex research workflows into streamlined, intelligent processes.</p>
                    <p className="c-text-4">The platform enables professionals to conduct in-depth research, screen thousands of documents, and create share-ready deliverables with agents that consider every detail, source every claim, and synthesize real insights.</p>
                  </div>
            ...
            <section className="c-section partner-faq">
              <div className="c-container">
                <div className="v-40">
                  ...
                  <div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b210-9813ca54" className="c-line"></div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b211-9813ca54" className="accordion-wrap">
                      <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                        <div className="accordion_toggle">
                          <div className="c-text-2 cc-balance">Who qualifies as a referral?</div>
                          ...
                          <div mask-height="element">
                            <div className="accordion_content">
                              <div className="c-text-4 w-richtext">
                                <ul role="list">
                                  <li>The referred individual must be a qualifying private equity or private credit investment professional.</li>
                                  <li>The referred individual or entity must not currently be a Brightwave customer or active prospect in Brightwave&#x27;s sales pipeline at the time of the referral</li>
                                  <li>A referral may not be generated from a partners same company</li>
                                  <li>Self-referrals are disallowed</li>
                                  <li>The referral was may not be generated through prohibited activities as described in Section 4.2 of the Partner Terms of Service</li>
                                  <li>Other cases in which the referral does not meet the requirements outlined by referral offers at Brightwave&#x27;s sole discretion in cases of dispute.<br /></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                    ...
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b222-9813ca54" className="c-line"></div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b223-9813ca54" className="accordion-wrap">
                      <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                        <div className="accordion_toggle">
                          <div className="c-text-2 cc-balance">What are the partner eligibility requirements?</div>
                          <div chevron-x="" className="c-svg-2 cc-20 w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M12 5V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                              <path d="M5 12H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg></div><input accordion-checkbox="" type="checkbox" className="accordion_checkbox" />
                    ...
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b231-9813ca54" className="c-line"></div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b232-9813ca54" className="accordion-wrap">
                      <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                        <div className="accordion_toggle">
                          <div className="c-text-2 cc-balance">What are the commission terms?</div>
                          <div chevron-x="" className="c-svg-2 cc-20 w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M12 5V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                              <path d="M5 12H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg></div><input accordion-checkbox="" type="checkbox" className="accordion_checkbox" />
                        ...
                        <div accordion="element" className="accordion_dropdown">
                          <div mask-height="element">
                            <div className="accordion_content">
                              <div className="c-text-4 w-richtext">
                                <p>Commissions are earned upon the submission of a lead form by a referral. The commission&#x27;s payout is contingent on the referral meeting with the Brightwave sales team within 30 days. If a meeting does not occur for any reason, the commission is forfeited. This includes:</p>
                                <ul role="list">
                                  <li>Cancellation by the Brightwave team</li>
                                  <li>Cancellation by the referral</li>
                                  <li>Postponement by the referral beyond 30 days</li>
                                  <li>Disqualification of the referral based on their job role, title, or firm or any other reason</li>
                                </ul>
                                <p>Once earned, commissions are paid out at the conclusion of the 30-day holding period contingent on completion of the qualification terms. If a prospect is disqualified for any reason, the commission is cancelled and will not be paid out.<br /></p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b243-9813ca54" className="c-line"></div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b244-9813ca54" className="accordion-wrap">
                      <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                        <div className="accordion_toggle">
                          <div className="c-text-2 cc-balance">What is the meeting like?</div>
                          <div chevron-x="" className="c-svg-2 cc-20 w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M12 5V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                              <path d="M5 12H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg></div><input accordion-checkbox="" type="checkbox" className="accordion_checkbox" />
                        ...
                        <div accordion="element" className="accordion_dropdown">
                          <div mask-height="element">
                            <div className="accordion_content">
                              <div className="c-text-4 w-richtext">
                                <p>The meeting is an initial call to establish if Brightwave&#x27;s solution would be a helpful for a referral and/or their team.</p>
                                <p>If there’s interest, the next step that we initiate is a free trial (no commitment, we provide access to the referral and their colleagues). If there’s not interest, then there is no commitment or next steps.<br /></p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b24c-9813ca54" className="c-line"></div>
                    <div id="w-node-b8474e2a-0c3b-eaca-c464-450a21d8b24d-9813ca54" className="accordion-wrap">
                      <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                        <div className="accordion_toggle">
                          <div className="c-text-2 cc-balance">Do referrals have to commit to anything in order for a commission to be earned?</div>
                          <div chevron-x="" className="c-svg-2 cc-20 w-embed"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M12 5V19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                              <path d="M5 12H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                            </svg></div><input accordion-checkbox="" type="checkbox" className="accordion_checkbox" />
