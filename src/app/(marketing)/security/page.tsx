            ...
            <div id="w-node-_3bbee836-a3f8-06de-9221-e35cf06798d6-529b11d5" className="legal_flex cc-gap-0">
              ...
              <div>
                ...
                <div accordion="" id="w-node-_0d758a7c-5986-fc72-0a2c-7e16d285f79d-d285f79d" className="accordion">
                  ...
                  <div accordion="element" className="accordion_dropdown">
                    <div mask-height="element">
                      <div className="accordion_content">
                        <div className="c-text-4 w-richtext">
                          <p>If you have any questions or concerns about the security of your data, please <a href="/referral">contact us</a> directly. Our team of experts is here to address your needs and ensure that your data remains protected at all times.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="legal-rt w-richtext">
                  ...
                  <p>For more detailed information regarding how we collect, use, and protect your personal data, please review our <a href="/privacy-policy">Privacy Policy</a>. By using our services, you agree to abide by our <a href="/terms-of-use">Terms of Use</a>, which outline the conditions for accessing and utilizing Brightwave’s platform and website.</p>
                </div>
